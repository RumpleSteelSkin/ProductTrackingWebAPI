...
public interface IAsyncRepository<TEntity, TId> where TEntity: Entity<TId>
{
    ...
    Task<ICollection<TEntity>> GetAllAsync(Expression<Func<TEntity, bool>>? filter = null, bool enableTracking = true, bool include = true, CancellationToken cancellationToken = default);
